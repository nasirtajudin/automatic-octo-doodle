# main.py
# ==============================================================================
# ETHIO LOTTERY - SHAMO (FAST KENO) PRIVATE RESEARCH TELEGRAM BOT
# ==============================================================================
...
#   * Scrapes Shamo (Fast Keno) history and monitors live draws
...
# CONFIGURATION
# ==============================================================================
APP_NAME = "ETHIO SHAMO RESEARCH BOT"
APP_VERSION = "2.0 (Telegram Cloud Edition)"
DB_PATH = "shamo_research.db"
BACKUP_DIR = "backups"
EXPORT_DIR = "exports"
...
class Database:
    ...
    def _connect(self) -> None:
        for attempt in range(DB_RETRIES):
            try:
                # check_same_thread=False is CRITICAL for Telegram bots
                # where Telegram thread and Playwright thread access the same DB
...
class BrowserBot:
    ...
    def start(self) -> bool:
        try:
            ...
            # Railway requires --no-sandbox and --disable-dev-shm-usage for Chromium
    ...
    def open_shamo_game(self) -> bool:
        try:
            try:
                more_btn = self.page.wait_for_selector('button:has-text("See More Games"), a:has-text("See More Games")', timeout=4000)
                if more_btn:
                    more_btn.click()
                    self.page.wait_for_timeout(2000)
            except: pass
            ...
            found = False
            for _ in range(15):
                candidates = self.page.query_selector_all('div, a, button, span, h2, h3, h4, img')
                for el in candidates:
                    try:
                        ...
                        if "shamo" in f"{txt} {alt} {title} {aria}".lower():
                            try: el.click()
                            except: el.evaluate("e => e.parentElement.click()")
...
class Machine:
    ...
    def setup_browser(self, username: str, password: str) -> bool:
        # Cloud environments (Railway) MUST be headless. Set to True always for safety.
...
class TelegramBot:
    ...
    async def cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if not user or not pwd:
            ...
            await context.bot.send_message(chat_id=self.chat_id, text="👋 Welcome to Ethio Shamo Bot!\n\nPlease enter your Ethio Lottery <b>Username</b>:", parse_mode="HTML")
        else:
            self.state = "MAIN"
    ...
    async def show_main_menu(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        text = (
            f"🤖 <b>ETHIO SHAMO RESEARCH BOT</b>\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
